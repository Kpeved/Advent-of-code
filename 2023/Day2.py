...
values2 = """Game 1: 3 blue, 2 green, 6 red; 17 green, 4 red, 8 blue; 2 red, 1 green, 10 blue; 1 blue, 5 green
...
values = """Game 1: 3 blue, 2 green, 6 red; 17 green, 4 red, 8 blue; 2 red, 1 green, 10 blue; 1 blue, 5 green
Game 2: 9 red, 2 green; 5 red, 1 blue, 6 green; 3 green, 13 red, 1 blue; 3 red, 6 green; 1 blue, 14 red, 6 green
Game 3: 6 red, 3 blue, 8 green; 6 blue, 12 green, 15 red; 3 blue, 18 green, 4 red
Game 4: 1 blue, 4 red; 2 blue, 6 red; 13 blue; 11 blue, 1 green, 8 red; 10 blue, 3 green, 2 red; 3 green, 7 blue
...
for line in valueLines :
    ...
    for game_result in game_results :
        balls_with_colors = game_result.split(', ')
        for balls_with_color in balls_with_colors :
            if "red" in balls_with_color :
                red_num = int(balls_with_color.lstrip().split(" ")[0])
                if red_num > max_red :
                    print("red not valid")
                    valid = False
                    break
            if "green" in balls_with_color :
                green_num = int(balls_with_color.lstrip().split(" ")[0])
                if green_num > max_green :
                    print("green not valid")
                    valid = False
                    break
            if "blue" in balls_with_color :
                blue_num = int(balls_with_color.lstrip().split(" ")[0])
                if blue_num > max_blue :
                    print("blue not valid")
                    valid = False
                    break
...
for line in valueLines :
    ...
    for game_result in game_results :
        ...
        for balls_with_color in balls_with_colors :
            if "red" in balls_with_color :
                red_num = int(balls_with_color.lstrip().split(" ")[0])
                min_red = max(min_red, red_num)
                
            if "green" in balls_with_color :
                green_num = int(balls_with_color.lstrip().split(" ")[0])
                min_green = max(min_green, green_num)
            
            if "blue" in balls_with_color :
                blue_num = int(balls_with_color.lstrip().split(" ")[0])
                min_blue = max(min_blue, blue_num)
                
    print("min_red : " + str(min_red))
    print("min_blue : " + str(min_blue))
    print("min_green : " + str(min_green))
